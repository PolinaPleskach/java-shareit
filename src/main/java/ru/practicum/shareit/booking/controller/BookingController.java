...
public class BookingController {
    ...
    @PostMapping
    public BookingFullDto create(@NotNull @RequestHeader(USER_ID_HEADER) Long userId,
    ...
    public BookingFullDto approved(@RequestHeader(USER_ID_HEADER) @NotNull Long userId,
    ...
    public BookingFullDto getById(@RequestHeader(USER_ID_HEADER) @NotNull Long userId,
    ...
    @GetMapping
    public List<BookingFullDto> getAllByBooker(@RequestHeader(USER_ID_HEADER) @NotNull Long userId,
    ...
    @GetMapping("/owner")
    public List<BookingFullDto> getAllByOwner(@RequestHeader(USER_ID_HEADER) @NotNull Long ownerId,
                                              @RequestParam(defaultValue = "ALL") @NotBlank String state) {
